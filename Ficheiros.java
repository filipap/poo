  ...
  */
  public static GestaoContribuintes carregaEstado (String nomeFicheiro) throws FileNotFoundException,IOException,ClassNotFoundException{
    ...
    public static void main(String[] arg) {
       ...
       Fatura f8 = new Fatura(130,"Lava Tudo Direitinho",LocalDate.of(2012,5,20),137,0.0,"lavagem + aspiração",10,at7);
       ...
       Fatura f11= new Fatura(130,"Lava Tudo Direitinho",LocalDate.of(2008,8,20),133,0.0,"lavagem + aspiração",10,at7);
       ...
       Fatura f17 = new Fatura(130,"Lava Tudo Direitinho",LocalDate.of(2013,8,20),135,0.0,"lavagem + aspiração",10,at7);
       Fatura f18 = new Fatura(126,"Universidade do Minho - Campus de Gualtar",LocalDate.of(2017,4,30),140,6.25,"senhas cantina",25,at3);
       Fatura f19 = new Fatura(130,"Lava Tudo Direitinho",LocalDate.of(2014,5,26),132,0.0,"lavagem",5,at7);
       ...
       Fatura f23 = new Fatura(130,"Lava Tudo Direitinho",LocalDate.of(2013,8,20),131,0.0,"aspiração",5,at7);
       ...
       Fatura f25 = new Fatura(130,"Lava Tudo Direitinho",LocalDate.of(2016,8,19),132,0.0,"lavagem + aspiração",10,at7);
       ...
       Fatura f28 = new Fatura(130,"Lava Tudo Direitinho",LocalDate.of(2013,8,20),132,0.0,"lavagem + aspiração",12,at7);
       ...
       Fatura f31 = new Fatura(130,"Lava Tudo Direitinho",LocalDate.of(2015,4,5),137,0.0,"lavagem + aspiração",10,at7);
       ...
       Fatura f35 = new Fatura(130,"Lava Tudo Direitinho",LocalDate.of(2016,8,23),133,0.0,"lavagem + aspiração",10,at7);
       ...
       Fatura f38 = new Fatura(130,"Lava Tudo Direitinho",LocalDate.of(2015,5,21),133,0.0,"lavagem + aspiração",10,at7);
