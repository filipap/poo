  ...
  */
  public static GestaoContribuintes carregaEstado (String nomeFicheiro) throws FileNotFoundException,IOException,ClassNotFoundException{
    ...
    public static void main(String[] arg) {
       ...
       Fatura f1 = new Fatura(123,"Hospital Particular das Gambelas",LocalDate.now(),131,4,"Consulta Medicina Dentaria",20,at);
       Fatura f2 = new Fatura(123,"Hospital Particular das Gambelas",LocalDate.of(2014,3,4),134,64,"Internamento\n Cirurgia de reconstruçao",320,at);
       Fatura f3 = new Fatura(128,"Pingo Doce",LocalDate.of(2010,5,02),131,11.15,"pasta de dentes\n robo cozinha",223,at5);
       Fatura f4 = new Fatura(123,"Hospital Particular das Gambelas",LocalDate.of(2013,8,20),137,4,"Consulta Medicina Interna",20,at);
       ...
       Fatura f7 = new Fatura(125,"Cortes de Lisboa",LocalDate.of(2013,8,20),137,0.350,"corte cabelo",5,at2);
       Fatura f8 = new Fatura(130,"Lava Tudo Direitinho",LocalDate.of(2012,5,20),137,0.0,"lavagem + aspiração",10,at9);
       Fatura f9 = new Fatura(125,"Cortes de Lisboa",LocalDate.of(2017,8,22),136,0.350,"corte cabelo",5,at2);
       Fatura f10 = new Fatura(126,"Universidade do Minho - Campus de Gualtar",LocalDate.of(2005,2,18),131,1.00,"Pedido exame época especial",5,at3);
       ...
       Fatura f13 = new Fatura(125,"Cortes de Lisboa",LocalDate.of(2014,12,20),132,0.350,"corte cabelo",12,at2);
       Fatura f14 = new Fatura(127,"Restaurante Foz",LocalDate.of(2012,10,20),135,0.750,"Diária",5,at4);
       Fatura f15 = new Fatura(125,"Cortes de Lisboa",LocalDate.of(2014,11,10),134,1.40,"coloração",20,at2);
       ...
       Fatura f18 = new Fatura(126,"Universidade do Minho - Campus de Gualtar",LocalDate.of(2017,4,30),140,5.0,"senhas cantina",25,at3);
       Fatura f19 = new Fatura(130,"Lava Tudo Direitinho",LocalDate.of(2014,5,26),132,0.0,"lavagem",5,at9);
       Fatura f20 = new Fatura(125,"Cortes de Lisboa",LocalDate.of(2012,5,27),134,0.350,"corte cabelo",5,at2);
       Fatura f21 = new Fatura(127,"Restaurante Foz",LocalDate.of(2017,4,22),135,4.50,"Rodízio",30,at4);
       Fatura f22 = new Fatura(125,"Cortes de Lisboa",LocalDate.of(2018,2,20),136,0.350,"corte cabelo",5,at2);
       Fatura f23 = new Fatura(130,"Lava Tudo Direitinho",LocalDate.of(2013,8,20),131,0.0,"aspiração",5,at9);
       Fatura f24 = new Fatura(126,"Universidade do Minho - Campus de Gualtar",LocalDate.of(2016,7,2),122,10.0,"Pedido transferência",50,at3);
       ...
       Fatura f29 = new Fatura(126,"Universidade do Minho - Campus de Gualtar",LocalDate.of(2018,4,20),135,5,"senhas cantina",25,at3);
       Fatura f30 = new Fatura(125,"Cortes de Lisboa",LocalDate.of(2013,4,2),138,2.10,"coloração + corte cabelo",30,at2);
       Fatura f31 = new Fatura(130,"Lava Tudo Direitinho",LocalDate.of(2015,4,5),137,0.0,"lavagem + aspiração",10,at9);
       Fatura f32 = new Fatura(125,"Cortes de Lisboa",LocalDate.of(2016,3,25),136,0.350,"corte cabelo",5,at2);
       ...
       Fatura f37 = new Fatura(125,"Cortes de Lisboa",LocalDate.of(2013,8,20),134,0.350,"corte cabelo",5,at2);
       Fatura f38 = new Fatura(130,"Lava Tudo Direitinho",LocalDate.of(2015,5,21),133,0.0,"lavagem + aspiração",10,at9);
       Fatura f39 = new Fatura(125,"Cortes de Lisboa",LocalDate.of(2018,1,20),134,1.4,"coloração",20,at2);
       ...
       Fatura f42 = new Fatura(125,"Cortes de Lisboa",LocalDate.of(2014,10,20),132,0.350,"corte cabelo",5,at2);
       Fatura f43 = new Fatura(127,"Restaurante Foz",LocalDate.of(2015,9,20),136,0.750,"Diária",5,at4);
       Fatura f44 = new Fatura(125,"Cortes de Lisboa",LocalDate.of(2016,4,25),139,0.350,"corte cabelo",5,at2);
       ...
       Fatura f48 = new Fatura(123,"Hospital Particular das Gambelas",LocalDate.of(2014,8,26),136,4.0,"Consulta Ortopedia",20,at);
